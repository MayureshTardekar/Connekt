class AppConfig {
  ...
  static const String xaiApiKey = 'YOUR_XAI_KEY_HERE';

  // NVIDIA Configuration
  static const String nvidiaApiKey = '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';

  // Groq Configuration
  static const String groqApiKey = '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';

  // Gemini Configuration
  static const String geminiApiKey = 'AIzaSyAfy9TdW6oUFucM6B-BQ9by4HXzim10iVE'; 
  static const String geminiApiKeyBackup = 'AIzaSyD15gKjnQWrbtfAy4deTHVj6IFhIubDk1A'; 
  static const String geminiApiKeyTertiary = 'AIzaSyDxoXVKdbkerjFk_ADmrvTjGoSBoVgynW0';
}
