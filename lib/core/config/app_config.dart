class AppConfig {
  ...
  static const String geminiApiKey = String.fromEnvironment('GEMINI_API_KEY', defaultValue: 'AIzaSyD15gKjnQWrbtfAy4deTHVj6IFhIubDk1A'); 
  static const String geminiApiKeyBackup = 'AIzaSyAfy9TdW6oUFucM6B-BQ9by4HXzim10iVE'; // Use if primary key fails
}
