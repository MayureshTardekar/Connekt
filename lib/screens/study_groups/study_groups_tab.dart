              ...
              background: Container(
                ...
                child: Stack(
                  children: [
                    Positioned(
                      right: -20, bottom: -20,
                      child: Icon(Icons.groups_3_rounded, size: 160, color: Colors.white.withOpacity(0.06)),
                    ),
                    Positioned(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      return FutureBuilder<String?>(
                        future: _groupRepo.getMembershipStatus(group.id),
          ...
          Row(
            children: [
              ...
              if (isOwner)
                ...
                ElevatedButton(
                  onPressed: () => _groupRepo.requestToJoin(group.id),
