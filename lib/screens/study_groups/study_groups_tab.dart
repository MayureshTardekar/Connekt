              ...
              delegate: SliverChildListDelegate([
                if (_selectedTab == 0) ...[
                  _buildGroupCard(
                    ...
                    description:
                        'Midterm prep — integration techniques & series.',
                    creator: 'Jordan Davies',
                  ...
                  _buildGroupCard(
                    ...
                    description:
                        'Weekly session — wave mechanics & Schrödinger.',
                    creator: 'Aisha Lindholm',
                    dateTime: 'Tomorrow, 2:00 PM',
                    location: 'Science Block Lab 4',
                    memberCount: 5,
                    maxMembers: 5,
                    color: AppTheme.anonPurple,
                  ),
                  const SizedBox(height: 14),
                  _buildGroupCard(
                    context,
                    ...
                    description:
                        'Trees, graphs & dynamic programming practice.',
                    creator: 'Marcus Wright',
                    dateTime: 'Wed, 6:00 PM',
                    location: 'CS Lab 201',
                    memberCount: 2,
                    maxMembers: 6,
                  ...
                  _buildGroupCard(
                    ...
                    description: 'Macro economics principles & case studies.',
                    creator: 'Jamie Chen',
                    dateTime: 'Thu, 3:00 PM',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: isFull ? AppTheme.coral : AppTheme.emerald,
                    fontSize: 11,
                    fontWeight: FontWeight.w700,
                  ),
                ),
          ...
          Row(
            children: [
              _buildMiniChip(Icons.calendar_today_rounded, dateTime),
              const SizedBox(width: 8),
              Expanded(
                child: _buildMiniChip(Icons.location_on_rounded, location),
              ),
            ],
          ),
          const SizedBox(height: 14),
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              color: isFull ? AppTheme.coral : color,
              minHeight: 5,
            ),
          ),
              ...
              SizedBox(
                ...
                child: Stack(
                  children: List.generate(
                    memberCount.clamp(0, 3),
                    (i) => Positioned(
                      left: i * 14.0,
                      child: CircleAvatar(
                        radius: 10,
                        backgroundColor: Colors.white,
                        child: avatarWidget(memberNames[i], radius: 9),
                      ),
                    ),
                  ),
                ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: isFull && !isJoined
                        ? []
                        : [
                            BoxShadow(
                              color: (isJoined ? AppTheme.emerald : color)
